...
const mapMongoDataToReduxFormat = (mongoData: MongoData): ResumeState => {
  ...
  // Helper function to ensure array has at least one empty item
  const ensureDefaultItem = <T>(
    array: T[] | undefined,
    createDefault: () => T
  ): T[] => {
  ...
  return {
    ...
    // Work Experience
    workExperience: ensureDefaultItem(mongoData.workExperience, () => ({
      id: generateId("job"),
      jobTitle: "",
      company: "",
    ...
    // Education
    education: ensureDefaultItem(mongoData.education, () => ({
      id: generateId("edu"),
      degree: "",
      school: "",
      startDate: { month: "", year: "" },
    ...
    // Social Links
    socialLinks: ensureDefaultItem(mongoData.socialLinks, () => ({
    ...
    // Projects
    projects: ensureDefaultItem(mongoData.projects, () => ({
      id: generateId("proj"),
      title: "",
      technologies: [],
      role: "",
    ...
    // Languages
    languages: ensureDefaultItem(mongoData.languages, () => ({
      id: generateId("lang"),
      name: "",
      proficiency: "",
      isCustom: false,
    ...
    // Certificates
    certificate: ensureDefaultItem(mongoData.certificate, () => ({
      id: generateId("cert"),
      name: "",
      issuingOrganization: "",
    ...
    // Awards
    awards: ensureDefaultItem(mongoData.awards, () => ({
      id: generateId("award"),
      name: "",
      issuer: "",
      date: { month: "", year: "" },
    ...
    // Open Source Contributions
    openSourceContributions: ensureDefaultItem(
      mongoData.openSourceContributions,
      () => ({
        id: generateId("open-source"),
        projectName: "",
        role: "",
        technologies: [],
        description: "",
    ...
    // Custom Sections
    customSections: ensureDefaultItem(mongoData.customSections, () => ({
