...
// import QuillField from "@/components/QuillField"; // Import the QuillField component
...
const SortableProjectItem = ({
  ...
  const handleContributionsChange = (content: string) => {
    handleLocalChange("contributions", content);
  };
        ...
        <AccordionContent className="px-4 py-2 space-y-4">
          ...
          <div>
            ...
            <QuillField
              ...
              placeholderText="Describe your key contributions and achievements in this project..."
            />
          </div>
          <div>
            <SubSectionTitle
