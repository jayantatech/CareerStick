...
const AISuggestionsBox = () => {
  ...
  return (
    <div
      className={`w-[580px] h-[440px] fixed bottom-4 rounded right-9 max-lg:hidden  bg-white border shadow-lg  ${
    ...
    >
      ...
      <div className="w-full h-[380px] flex flex-col gap-3 overflow-y-auto custom-scrollbar p-3">
