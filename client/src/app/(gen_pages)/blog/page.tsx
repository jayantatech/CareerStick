...
export const metadata: Metadata = {
  title: "CareerStick Blog - Career Tips, Resume Guides & AI Insights",
  description:
    "Get expert career advice, resume tips, and insights on AI-driven professional growth at the CareerStick blog.",
};
