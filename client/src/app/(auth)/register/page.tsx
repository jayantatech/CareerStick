...
export const metadata: Metadata = {
  title: "CareerStick Register - Build Your Perfect Resume Today",
  description:
    "Join CareerStick and create professional, AI-powered resumes effortlessly. Start for free and unlock premium features for enhanced customization and tools.",
};
